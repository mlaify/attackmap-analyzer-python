# Contributing to `attackmap-analyzer-python`
...
```bash
git clone https://github.com/mlaify/attackmap-analyzer-python.git
cd attackmap-analyzer-python
python -m venv .venv
...
Open a [bug report](https://github.com/mlaify/attackmap-analyzer-python/issues/new?template=bug_report.md).
...
Open a [feature request](https://github.com/mlaify/attackmap-analyzer-python/issues/new?template=feature_request.md).
...
By contributing to `attackmap-analyzer-python`, you agree that your contributions will be
